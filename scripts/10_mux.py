...
def main() -> int:
    """
    Main function for mux stage - combines video with subtitles.
...
def run_stage(job_dir: Path, stage_name: str = "10_mux") -> int:
    ...
    """
    # mux.py main() already uses StageIO internally
    # This wrapper just provides the standard run_stage() interface
    return main()
